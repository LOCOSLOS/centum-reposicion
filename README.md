...
Proyecto en etapa de construcción de la base de datos e integración. La ingesta diaria v2 de ventas quedó activa el 23 de julio de 2026. El stock se captura en un workflow independiente todos los días a las 03:00 ART y el reporte Excel conserva su flujo operativo separado a las 05:00 ART. Esta separación evita que el procesamiento del reporte afecte la persistencia utilizada por el sistema de reposición. Al 1 de agosto de 2026 el histórico continuo de ventas está validado desde el 27 de diciembre de 2024 hasta la actualidad mediante la ejecución `1957`. La próxima ventana pendiente, todavía sin configurar, es del 13 al 26 de diciembre de 2024. El backfill continuará hasta completar julio de 2024 y se detendrá allí, con una cobertura objetivo aproximada de 24 meses.
